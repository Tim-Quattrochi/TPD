...
return (
    ...
    <div className='flex flex-col'> 
                ...
                <div className="flex justify-center m-20">
                    <div className="flex flex-col md:flex-row md:max-w-xl rounded-lg bg-white backdrop-opacity-75 border-double border-4 border-amber-500">
                        ...
                        <p className="text-pink-800 text-xs"> Full Stack Developer </p>
                        </div>
                    </div>
                </div>  
                
                <div className="flex justify-center mb-20">
                    <div className="flex flex-col md:flex-row md:max-w-xl rounded-lg bg-white shadow-lg backdrop-opacity-75 border-double border-4 border-amber-500">
                        <img className="w-full h-96 md:h-auto object-cover md:w-48 rounded-t-lg md:rounded-none md:rounded-l-lg" 
                        src={Pete} 
                        alt="" />
                        <div className="p-6 flex flex-col justify-start">
                ...
                <div className="flex justify-center mb-20">
                    <div className="flex flex-col md:flex-row md:max-w-xl rounded-lg bg-white shadow-lg backdrop-opacity-75 border-double border-4 border-amber-500">
                        ...
                        <p className="text-pink-800 text-xs"> Professional Troll </p>
                        </div>
                    </div>
                </div>
