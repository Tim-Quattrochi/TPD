            ...
            <form onSubmit={handleRegistration} className='flex flex-col items-center'>
                ...
                <div className='usernameInputField w-full p-2' >
                    ...
                    <input  type="text"
                            ...
                            className=' bg-slate-200 w-6/12 mb-3'
                    /> 
                    <p id="uidnote" className={`${userFocus && userName && !validName ? "visible text-left pl-64" : "invisible p-0 m-0 h-0 w-0"} `}>
                ...
                <div className='passwordInputField w-full p-2'> 
                    ...
                    <p id="pwdnote" className={`${passwordFocus && !validPassword ? "visible text-left pl-64" : "invisible p-0 m-0 h-0 w-0"}`}>
                            <FontAwesomeIcon icon={faInfoCircle} />
                ...
                <div className='pswConfirmInputField w-full p-2'>
                    ...
                    <label htmlFor="confirm_password" className='p-2' >
                        <FontAwesomeIcon icon={faCheck} className={validMatch && matchPassword ? "visible" : "invisible"} />
                        <FontAwesomeIcon icon={faTimes} className={!validMatch || !matchPassword ? "visible" : "invisible"} />
                    </label>
                    ...
                    <p id="confirmnote" className={matchFocus && !validMatch ? "visible text-left pl-64" : "invisible p-0 m-0 h-0 w-0"}>
                        <FontAwesomeIcon icon={faInfoCircle} />
