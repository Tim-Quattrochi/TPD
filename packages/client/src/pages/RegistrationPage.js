        ...
        <form onSubmit={handleRegistration} className='flex flex-col items-center'>
            ...
            <div className='usernameInputField w-full p-2' >
                ...
                <input  type="text"
                        ...
                        className=' bg-slate-200 w-6/12 mb-3'
                /> 
                <p id="uidnote" className={`${userFocus && userName && !validName ? "instructions" : "offscreen"} text-left pl-64`}>
            ...
            <div className='passwordInputField w-full p-2'> 
                ...
                <p id="pwdnote" className={`${passwordFocus && !validPassword ? "instructions" : "offscreen"} text-left pl-64`}>
                        <FontAwesomeIcon icon={faInfoCircle} />
            ...
            <div className='pswConfirmInputField w-full p-2'>
                ...
                <p id="confirmnote" className={`{matchFocus && !validMatch ? "instructions" : "offscreen"} text-left pl-64`}>
                    <FontAwesomeIcon icon={faInfoCircle} />
